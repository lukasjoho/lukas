...
export async function middleware(req: NextRequest, event: NextFetchEvent) {
  ...
  console.log('REQ: ', JSON.stringify(req.headers.get('Sec-purpose')));
  console.log('REQ2: ', JSON.stringify(req.headers.get('sec-purpose')));
  console.log('DEST: ', JSON.stringify(req.headers.get('sec-fetch-dest')));
  console.log('Purpose: ', JSON.stringify(req.headers.get('Purpose')));
  console.log('Purpose1: ', JSON.stringify(req.headers.get('purpose')));
